...
public interface Feature extends Identifiable {
     ...
     * bidirectional and its opposite is '{@link featJAR.GroupNode#getFeatureList
     * <em>Feature List</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
    ...
    /**
     * Sets the value of the '{@link featJAR.Feature#getParent <em>Parent</em>}'
    ...
    /**
     * Returns the value of the '<em><b>Group Node List</b></em>' containment
     * reference list. The list contents are of type {@link featJAR.GroupNode}. It
     * is bidirectional and its opposite is '{@link featJAR.GroupNode#getParent
     * <em>Parent</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
     *
     * @return the value of the '<em>Group Node List</em>' containment reference
     *         list.
    ...
    /**
     * Sets the value of the '{@link featJAR.Feature#getCardinality
     * <em>Cardinality</em>}' containment reference. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @param value the new value of the '<em>Cardinality</em>' containment
     *              reference.
     * @see #getCardinality()
     * @generated
     */
