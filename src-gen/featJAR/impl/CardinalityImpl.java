...
public class CardinalityImpl extends MinimalEObjectImpl.Container implements Cardinality {
	...
	public void setLowerBound(int newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatJARPackage.CARDINALITY__LOWER_BOUND,
	...
	public void setUpperBound(int newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FeatJARPackage.CARDINALITY__UPPER_BOUND,
