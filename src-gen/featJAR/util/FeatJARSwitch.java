 ...
 * @generated
 */
public class FeatJARSwitch<T> extends Switch<T> {
    /**
    ...
    protected T doSwitch(int classifierID, EObject theEObject) {
        switch (classifierID) {
            ...
            case FeatJARPackage.GROUP_NODE: {
                ...
                T result = caseGroupNode(groupNode);
                if (result == null) result = caseIdentifiable(groupNode);
                if (result == null) result = defaultCase(theEObject);
                return result;
            }
     ...
     * '<em>Identifiable</em>'. <!-- begin-user-doc --> This implementation returns
    ...
    /**
     * Returns the result of interpreting the object as an instance of
     * '<em>Attributes</em>'. <!-- begin-user-doc --> This implementation returns
     * null; returning a non-null result will terminate the switch. <!--
     * end-user-doc -->
     *
     * @param object the target of the switch.
