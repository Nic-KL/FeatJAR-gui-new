...
public class FeatureTreeLayouter {
    ...
    /**
     * Returns the "last child" in display order: repeatedly takes the last child of
     ...
     */
    public static Point computeAnchorBelowRightmostLeaf(
            final TreeNode root, final double nodeWidth, final double nodeHeight, final double marginY) {
    ...
    /**
     * Computes the TOP-LEFT position to place a rectangular legend of given size so
     * that it is horizontally centered under the rightmost leaf.
     *
    ...
    public static double computeYBelowDeepestRightmostLeaf(
            final TreeNode root, final double nodeHeight, final double marginY) {
